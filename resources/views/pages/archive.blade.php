	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Arrchives</h1>
				    </div>
					     ...
					     <div class="page-utilities">
                             <form class="">
						        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <button type="button" class="btn app-btn-secondary">Telecharge Tous</button>
                                    </div>
			    ...
			    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4 border border-dashed rounded-5 px-3  shadow-sm">
				    ...
				    <a class="flex-sm-fill text-sm-center nav-link" id="orders-cancelled-tab" data-bs-toggle="tab" href="#orders-cancelled" role="tab" aria-controls="orders-cancelled" aria-selected="false">Bon Livreson</a>
				</nav>
					    ...
					    <div class="app-card app-card-orders-table  mb-3">
						    <div class="app-card-body">
                                    ...
                                    <div class="row g-4 p-3">
                                        ...
                                        @foreach ($factuer as $itms )

                                            <!--//col-->
                                            <div class="col-6 col-md-4 col-xl-4 col-xxl-2">
                                                <div class="app-card app-card-doc shadow-sm h-100">
                                                    <div class="app-card-thumb-holder p-3">
                                                        <span class="icon-holder">
                                                            <svg class="svg-inline--fa fa-file-pdf pdf-file" width='40' height="40"  aria-hidden="true" focusable="false"
                                                        ...
                                                        @if ($itms->created_at->diffForHumans()>1)
                                                    ...
                                                    <div class="app-card-body p-3 has-card-actions">
                                                        ...
                                                        <h3 class="app-doc-title truncate mb-0">Matricule: {{$itms->matriqulCar}}</h3>
                                                        <div class="app-doc-meta">
                                                            <ul class="list-unstyled mb-0">
                                                                <li><span class="text-muted">Type: </span> Factuer</li>
                                                                <li><span class="text-muted">Facture N°:</span>{{$itms->numFacture}}</li>
                                                                {{-- <li><span class="text-muted">Creation : </span>{{ $itms->created_at->day}} {{ $itms->created_at->monthName}}</li> --}}
                                                                <li><span class="text-muted">Creation : </span> {{$itms->created_at->diffForHumans()}} </li>
                                                            </ul>
                                                        </div>
                                                        <!--//app-doc-meta-->
                                                        ...
                                                        <div class="app-card-actions">
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item" href="{{route('factuer.show',$itms->id)}}">
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item" href="{{route('factuer.edit',$itms->id)}}">
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item" href="#"><svg width="1em"
