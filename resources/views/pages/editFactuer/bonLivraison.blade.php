                            ...
                            <div class="app-card app-card-chart h-100 shadow-sm">
                                ...
                                <div class="app-card-header p-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <h4 class="app-card-title p-1">Creation Bon Livraison</h4>
                                ...
                                <div class="app-card-body p-3 p-lg-4">
                                    ...
                                    <div class=" shadow-sm border border-dashed rounded-4 px-4 mb-3 shadow-sm">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="">
                                                    <div class=" d-flex align-items-center ">
                                                        <label class="m-0 text-nowrap me-2 fw-bold">Bon Livraison N°:</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <label class="form-label  fw-bold">Designation<span class="text-primary">*</span></label>
                                                                <button type="button" class="btn m-0 p-0 text-info text-decoration-underline" data-bs-toggle="modal" data-bs-target="#exampleModal">(Ajoute Designation)</button>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3 row">
                                                                <label for="inputPassword" class="col-sm-4 col-form-label">Qté</label>
                                                                <div class="col-sm-8">
                                        ...
                                        <hr>
                                        <div>
                                            <p class="  small">Arrêté la présente Bon Livraison à la somme de <span id="zoneSome" class="fw-bold"></span> dirhams ttc.</p>
			        ...
			        <div class="tab-pane fade " id="ShowFactuer" role="tabpanel" aria-labelledby="orders-paid-tab">
                        ...
                        <div class="col-12 ">
                            ...
                            <div class="app-card-header p-3  border border-bottom">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <h4 class="app-card-title ">Show Bon Livraison</h4>
                                        ...
                                        <div class="  border border-dashed  mx-5 mb-4 ">
                                            <div class="row p-3">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="">
                                                        <div class=" d-flex align-items-center ">
                                                            <p class="m-0 text-nowrap me-3 fw-bold ">Bon Livraison N°: <span class=" fw-semibold" id="Show_numFacture">F-233-12</span></p>
                                                        </div>
                                                    </div>
