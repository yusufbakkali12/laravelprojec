...
@section('content')
                            ...
                            <div class="app-card app-card-chart h-100 shadow-sm">
                                ...
                                <div class="app-card-header p-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <h4 class="app-card-title p-1">Edit Factuer</h4>
                                ...
                                <div class="app-card-body p-3 p-lg-4">
                                    ...
                                    <div class=" shadow-sm border border-dashed rounded-4 px-4 mb-3 shadow-sm">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="">
                                                    <div class=" d-flex align-items-center ">
                                                        <label class="m-0 text-nowrap me-2 fw-bold">Facture N°:</label>
                                                        <input type="number" class="form-control disabled" disabled value="{{ $factuer->id}}"  id="numFacture" onkeyup="check_numFacture(this)">
                                                ...
                                                <div class="d-flex align-items-center ms-2">
                                                    ...
                                                    <input type="date" class="form-control ms-3" id="date" value="{{$factuer->date}}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class=" ">
                                                <div class="mb-3 d-flex justify-content-between ">
                                                    <div class="d-flex align-items-center ">
                                                        ...
                                                        <select class="form-select selectpicker ms-3" id="objectCar" data-live-search="true" required="">
                                                            @php
                                                            $Objets=['reparation du véhicule',
                                                            'Achat de pièces de recharge et reparation du véhicule',
                                                            'Achat de pièces de recharge et reparation du véhicule']
                                                            @endphp
                                                            @foreach ($Objets as $Objet)
                                                            <option value="{{ $Objet }}" @selected(old('Unite',$factuer->objectCar) == $Objet)>
                                                                {{ $Objet }}
                                                            </option>
                                                            @endforeach
                                                    ...
                                                    <div class="d-flex align-items-center ms-2">
                                                        ...
                                                        <input type="text" class="form-control ms-3" id="modelCar" value="{{$factuer->modelCar}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 d-flex justify-content-between ">
                                                    <div class="d-flex align-items-center ms-2">
                                                        ...
                                                        <input type="text" class="form-control ms-1 text-uppercase" id="matriqulCar" value="{{$factuer->matriqulCar}}">
                                                    </div>
                                                    <div class="d-flex align-items-center ms-1" aria-autocomplete="0">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control ms-1 text-uppercase " id="kilometrageCar" value="{{$factuer->kilometrageCar}}">
                                        ...
                                        <div class="row  p-3 justify-content-around" id="zoneProdut">
                                            ...
                                            <div>
                                                @foreach ( $factuer->Designation as $designation )
                                                    ...
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-4 px-1">
                                                            ...
                                                            <div class="wrapper">
                                                                <div class="select-btn" onclick="FselectBtn(this)">
                                                                    <span>{{old('Qte[]',$designation->Designation) }}</span>
                                                        ...
                                                        <div class="col-sm-1 px-1">
                                                            <div class="input-group">
                                                                <!-- ! ####### input prix ########  -->
                                                                <input type="number" name="Qte[]" class="form-control" id="Qte" placeholder="Qté" value="{{old('Qte[]',$designation->Qte) }}" onkeyup="calculeQte(this)">
                                                                <!-- !####### input prix ########  -->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-1 px-1">
                                                            <select name="Unite[]" id="Unite" class=" form-select">
                                                                @php
                                                                $Unites=['Piece','Litter','Faire']
                                                                @endphp
                                                                @foreach ($Unites as $Unite)
                                                                <option value="{{ $Unite }}" @selected(old('Unite',$designation->Unite) == $Unite)>
                                                                    {{ $Unite }}
                                                                </option>
                                                                @endforeach
                                                        ...
                                                        <div class="col-sm-3 px-1">
                                                            <div class="input-group">
                                                                <input type="number" name="PrixUniter" class="form-control " id="PrixUniter" value="{{old('Qte[]',$designation->PrixUniter) }}"
                                                                placeholder="Prix Uniter" onkeyup="calculePrixUniter(this)">
                                                        ...
                                                        <div class="col-sm-2 px-1">
                                                            <div class="input-group">
                                                                <input type="number" name="PrixTotal" class="form-control border border-2" id="PrixTotal" placeholder="Prix Total" value="{{old('Qte[]',$designation->PrixTotal)}}" disabled>
                                                                <span class="input-group-text">DH</span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row p-3 col-10 col-sm-8 col-md-6  col-xl-4 ms-auto ">
                                            <div class="mb-3 d-flex">
                                                ...
                                                <div class="col-6 ms-auto">
                                                    <input id="montantHt" type="text" readonly="" class="form-control" value="{{ $factuer->MontantHT }}">
                                                </div>
                                            ...
                                            <div class="mb-3 d-flex ">
                                                ...
                                                <div class="col-6 ms-auto">
                                                    <input id="montantTv" type="text" readonly="" class="form-control" value="{{$factuer->MontantTVA}}">
                                                </div>
                                            ...
                                            <div class="mb-3 d-flex">
                                                ...
                                                <div class="col-6 ms-auto">
                                                    <input id="montantTTC" type="text" readonly="" class="form-control " value="{{$factuer->MontantTTC}}">
                                                </div>
                                        ...
                                        <hr>
                                        <div>
                                            <p class="  small">Arrêté la présente factuer à la somme de <span id="zoneSome" class="fw-bold"></span> dirhams ttc.</p>

                                        </div>
                                        <div class="mt-5">
                                            <button class="btn btn-warning text-white rounded-5 px-3" id="CompletFactuer" onclick="insertObject()"
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="card-header-action">
                                                ...
                                                <style>@media print {.divhiden{display:none;}}</style>
                                                ...
                                                <div class="d-flex align-items-center ">
                                                    <div class="d-flex align-items-center mx-auto">
                                                        <p class="form-label m-0 fw-bold small">Objet :
                                                            ...
                                                            <span id="Show_matriqulCar" class="text-decoration-underline">3437-A-78</span> <br>
                                                            <span id="Show_modelCar" class=" fw-semibold text-center">SKODA </span>,
                                                            <span id="Show_kilometrageCar" class="fw-normal text-center">56000Km</span>
                                                        </p>
    ...
    <script defer src=" {{ asset("assets/js/Createfacture/factuer/edit.js") }}"></script>
@endsection
