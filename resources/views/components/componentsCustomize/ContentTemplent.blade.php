@foreach($templents as $templent)
    <div class="tab-content border border-dashed  rounded-5  shadow-sm overflow-hidden tab-pane fade " id="{{str_replace(' ', '', $templent->name)}}">
            <!--//nav create show-->
            <nav id="orders-table-tab" class="orders-table-tab rounded-5 app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-2 border border-dashed  px-3  shadow-sm m-2">
                <a class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" href="#{{str_replace(' ', '', $templent->name)}}create" role="tab" aria-controls="orders-all" aria-selected="true">
                ...
                <a class="flex-sm-fill text-sm-center nav-link "   id="orders-paid-tab" data-bs-toggle="tab" href="#{{str_replace(' ', '', $templent->name)}}show" role="tab" aria-controls="orders-paid" aria-selected="false">
        ...
        <!--//nav create show-->
        <!--//creation-->
            <div class="tab-pane fade show active" id="{{str_replace(' ', '', $templent->name)}}create" role="tabpanel" aria-labelledby="orders-all-tab">
                <div class="col-12 ">
                    <div class="app-card app-card-chart h-100 shadow-sm">
                        <div class="app-card-header p-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <h4 class="app-card-title p-1">Creation {{$templent->name}}</h4>
                                </div>
                                <!--//col-->
                                <div class="col-auto">
        ...
        <!--//Show-->
            <div class="tab-pane fade " id="{{str_replace(' ', '', $templent->name)}}show"  role="tabpanel" aria-labelledby="orders-paid-tab">
                ...
                <div class="col-12 ">
                    <div class="app-card app-card-chart h-100 shadow-sm">
                                ...
                                <div class="col-auto">
                                    <div class="card-header-action">
                                            ...
                                            <div class=" m-0 divhiden " >
                                                ...
                                                <button class="btn btn-info text-white rounded-5 px-3 " id="btn_imprimy" onclick="printDiv('{{str_replace(' ', '', $templent->name)}}divprinter')" >
                        ...
                        <div class="d-flex justify-content-center bg-body item"  >
                            <div class="border m-4   position-relative shadow-sm" style="width: 21cm;min-height: 29.7cm; " id="{{str_replace(' ', '', $templent->name)}}divprinter">
                                
                                    <div class=" px-5 my-3  " id="grid-snap">
            ...
            {{-- // import interact from 'https://cdn.interactjs.io/v1.10.19/interactjs/index.js' --}}
        <script>
